...
@section('content')
    @php
        $filter = [
            ...
            'app_id' =>(int) \Illuminate\Support\Facades\Request::get('app_id',null),
...
{{--                        <div class="col col-lg-2">--}}
{{--                            <select class="apps form-select" name="app_id" style="width: 100%;">--}}
{{--                                <option value="" selected>Chọn 1 app</option>--}}
{{--                                @foreach ($apps as $app)--}}
{{--                                    <option--}}
{{--                                        value="{{ $app->id }}" {{ request('app_id') == $app->id ? 'selected' : ''}}>{{ $app->name }}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
{{--                        </div>--}}
...
{{--                            <td>{{$c->monthly_rating}}</td>--}}
                            ...
                            <td>{{$c->created_at}}</td>
                            <td width="100">
                                <a href="{!! route('admin.categories.edit',['id' => $c->id, 'page' => (int) \Illuminate\Support\Facades\Request::get('page', null)]) !!}" title="Cập nhật"
