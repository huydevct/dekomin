    ...
    <div class="container flex">
        ...
        <div class="flex items-center justify-between flex-grow pl-12">
            <div class="flex items-center space-x-6 capitalize">
                <a href="../client.blade.php" class="text-gray-200 hover:text-white transition">Home</a>
                <a href="shop.blade.php" class="text-gray-200 hover:text-white transition">Shop</a>
